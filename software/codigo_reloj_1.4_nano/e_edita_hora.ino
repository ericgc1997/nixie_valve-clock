void editaHora()
{
  ...
  while(!editado)
  {
    ...
    miminuto=Dmin*10+Umin;      //guardamos el la variable mi hora los valores seleccionados en las valvulas
    mihora=Dhora*10+Uhora;      //guardamos el la variable mi hora los valores seleccionados en las valvulas 1 y 2 
    misegundo=0;
